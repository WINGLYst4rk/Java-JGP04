...
public class P0230UsoArrays {
	...
	public static void main(String[] args) {
		...
		System.out.print("Nº de elementos ? "); // lê nº de elementos
		...
		// lê possições inicial e final da cópia
		System.out.print("Possição inicial da copia? ");
		int de = sc.nextInt();
		System.out.print("Possição final da copia? ");
		int para = sc.nextInt();
